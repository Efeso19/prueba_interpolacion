...
${OBJECTDIR}/Clases/PhysicsState.o: Clases/PhysicsState.cpp 
	${MKDIR} -p ${OBJECTDIR}/Clases
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/local/SFML/include -IIncludes -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/PhysicsState.o Clases/PhysicsState.cpp

${OBJECTDIR}/Clases/Player.o: Clases/Player.cpp 
	${MKDIR} -p ${OBJECTDIR}/Clases
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/local/SFML/include -IIncludes -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/Player.o Clases/Player.cpp

${OBJECTDIR}/Clases/Render.o: Clases/Render.cpp 
	${MKDIR} -p ${OBJECTDIR}/Clases
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/local/SFML/include -IIncludes -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/Render.o Clases/Render.cpp
